...
# Docker sometimes causes more buffering issues with the audio. Running directly on the host is recommended for best performance. Same goes for running Lavalink in Docker.
